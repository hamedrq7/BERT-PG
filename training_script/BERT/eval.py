...
def main():
    ...
    if args.task_name is not None and not args.eval_adv_glue:
        ...
        extension = (args.validation_file).split(".")[-1]
        raw_datasets = load_dataset(extension, data_files=data_files, field=str(args.task_name))
    ...
    if args.sodef_model is not None: 
        ...
        t = 5.
        sodef = Phase3Model(
            bridge_layer=MLP_OUT_ORTH_X_X(feature_dim, bridge_dim), 
            ode_block=ODEBlock(odefunc=ODEfunc_mlp(bridge_dim), t = t), 
