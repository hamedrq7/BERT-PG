...
def get_args():
    ...
    parser.add_argument("--skip_phase3", action="store_true", help="Skips phase3, make sure to pass mode path for other phases")
    ...
    assert args.num_classes == 2 or args.num_classes == 3, 'for more classes, the MAX_ROW_DIS function is not sufficient (Complete this later)'
